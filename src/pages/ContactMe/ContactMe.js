    ...
    return (
        <>
            ...
            <Container className='my-5'>
                ...
                <h1 className='text-center display-1 fw-bolder title'>Feel free to reach me. </h1>
                <Row className='my-3 py-3'>
                    <Col className='shadow-lg custom-radius my-auto' lg={4}>
                        <div className="p-4 d-flex flex-column align-items-center">
                            <div className='d-flex align-items-center my-3'>
                                <div className='bg-warning rounded-circle p-3 me-3'><img src={location} alt="" /></div>
                                <div className='mt-2'>
                            ...
                            <div className='d-flex align-items-center my-3'>
                                <div className='bg-warning rounded-circle p-3 me-3'><img src={email} alt="" /></div>
                                <div className='mt-2'>
                            ...
                            <div className='d-flex align-items-center my-3'>
                                <div className='bg-warning rounded-circle p-3 me-3'><img src={phone} alt="" /></div>
                                <div className='mt-2'>
